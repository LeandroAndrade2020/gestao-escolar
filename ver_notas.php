...
<?php
    ...
    $sql = "SELECT matricula.ra,matricula.nome, notas.* FROM matricula LEFT JOIN notas ON matricula.ra = notas.ra_aluno_notas where matricula.escola = '$nome_escola' and matricula.serie = '$serie[0]' and matricula.turma = '$serie[1]' and matricula.codigo_classe='{$serie[2]}' order by nome asc ";
    $result = $conexao->query($sql);


    echo '<h1>' . $nome_escola . '</h1>';
    echo '<b> Classe: </b>'.  $serie[0] . '°' . $serie[1] . '<br>';
