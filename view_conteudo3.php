...
<body>
    ...
    <table class='table table-hover'>
        ...
        <?php 
        $sql = "select nome, rg, id, serie, turma, disciplina, data_nascimento from professor where escola = '$escola' order by nome asc";
        ...
        foreach($result as $consultas){
            ...
            <form action='edita_prof.php' method='POST'> 
                ...
                echo "<td>
                    ...
                    <small class='form-text text-muted text-center' style='font-size: 11px;'>Este campo não pode ser editado!</small>
                </td>";
                ...
                echo "<td>
                    ...
                    echo "<td style='display: flex;'>
                        <input type='submit' class='btn btn-outline-success mr-1' value='Salvar'>
                </form>

                <form action='apaga_prof.php'> 
                    <input name='id' type='hidden' value='{$consultas['id']}'>
                    <input type='submit' class='btn btn-outline-danger' value='Apagar' style=''>
                </td>
                    </form> 
                </td>";
            echo '</tr>';
