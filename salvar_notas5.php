<?php
    ...
    foreach($alunos_nota as $aluno){
        ...
        $sqlVerifica = "SELECT ra_aluno_notas from notas5 where ra_aluno_notas = '{$ras[$i]}'";
        ...
        //Deleta
        $del = "DELETE FROM notas5 WHERE ra_aluno_notas = '{$ras[$i]}'";
        $conexao->query($del);

        $sql = "INSERT INTO notas5(ra_aluno_notas,rg_professor,nmat,ning,nport,ncie,nhist,ngeo,nart,nemp,nedf)  
