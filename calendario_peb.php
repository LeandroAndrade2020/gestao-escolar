...
<body class="mx-auto text-center">
    <h1 class="mb-3">Envios de atividades PEB I</h1>
    <form class="box row mx-auto" action="visualizar.php" method="POST">
       
        Data <br>
        <input type='text' placeholder="Data" name="data" class="datepicker-here" data-language='pt-BR' inline="true" data-position="right top" />
        ...
        <div class=" row d-inline mb-0 pb-0">
        Qtd. aulas: <br>
            1° <input type="checkbox" name="aulas[]" value="1">
        </div>

        Conteúdo: <br>
        <input type='text' name="conteudo" place="conteudo" value="Operações básicas" /><br><br>
