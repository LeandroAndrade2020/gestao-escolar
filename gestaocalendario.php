...
<body class="mx-auto text-center">
    ...
    <h1 class="mb-3">Envios de atividades</h1>
    <form class="box row mx-auto" action="gestaovisualizar2.php" method="POST">
        Data <br>
        <input type='text' placeholder="Data" name="data" class="datepicker-here" data-language='pt-BR' inline="true"
            data-position="bottom left" required maxlength="10"/>
        ...
        <p class="w-100 m-0 p-0">Experiência / Habilidade </p> <br>
        <input type='text' name="conteudo" place="conteudo" placeholder="Digite o conteúdo da atvidade" value=""
            required />
<br>
 <p class="w-100 m-0 p-0">Interação padrão</p> <br>
            <select name= interacao> <option> - </option><option>Facebook</option>  <option>Whatsapp</option>  <option>Outro</option>  <option>Classroom</option>   <option>Aula</option> <option>Impresso</option> </select>
